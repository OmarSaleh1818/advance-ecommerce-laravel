                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    data-role="tagsinput" value="{{ $products->product_size_ar }}"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_color_en" class="form-control"
                                     data-role="tagsinput" value="{{ $products->product_color_en }}"> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    data-role="tagsinput" value="{{ $products->product_color_ar }}"> 
